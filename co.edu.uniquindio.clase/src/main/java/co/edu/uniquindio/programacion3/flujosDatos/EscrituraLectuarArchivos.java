...
//			FileWriter fw=new FileWriter("C://td//directorioPrueba//fichero1.txt",false);
			FileWriter fw=new FileWriter("/Users/oscarsalazar/td_per/ws/td/directorioPrueba/fichero1.txt",true);
...
//			FileReader fr=new FileReader("C://td//directorioPrueba//fichero1.txt");
			FileReader fr=new FileReader("/Users/oscarsalazar/td_per/ws/td/directorioPrueba/fichero1.txt");
...
//			FileReader fr=new FileReader("C://td//directorioPrueba//fichero2.txt");
			FileWriter fw=new FileWriter("/Users/oscarsalazar/td_per/ws/td/directorioPrueba/fichero2.txt");
			FileReader fr=new FileReader("/Users/oscarsalazar/td_per/ws/td/directorioPrueba/fichero2.txt");
			//Escribimos en el fichero un String y un caracter 97 (a)
			fw.write("Esto es una prueb");
			fw.write(97);
			fw.write(97);
...
//				FileReader fr=new FileReader("C://td//directorioPrueba//fichero3.txt"))
		FileWriter fw=new FileWriter("/Users/oscarsalazar/td_per/ws/td/directorioPrueba/fichero3.txt");
		FileReader fr=new FileReader("/Users/oscarsalazar/td_per/ws/td/directorioPrueba/fichero3.txt"))
		{
			//Escribimos en el fichero un String y un caracter 97 (a)
...
//			BufferedWriter bw=new BufferedWriter(new FileWriter("C://td//directorioPrueba//fichero4.txt"));){
		...
		try(BufferedReader br=new BufferedReader(new FileReader("/Users/oscarsalazar/td_per/ws/td/directorioPrueba/fichero4.txt"));
			BufferedWriter bw=new BufferedWriter(new FileWriter("/Users/oscarsalazar/td_per/ws/td/directorioPrueba/fichero4.txt"));){
...
//		File ficheroNuevo=new File("C://td//directorioPrueba//fichero5.txt");
		File ficheroNuevo=new File("/Users/oscarsalazar/td_per/ws/td/directorioPrueba/autos.txt");
